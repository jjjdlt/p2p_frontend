...
import { ClientRendezvousFailureReason, MSC4108FailureReason, RendezvousError } from ".";
import { logger } from "../logger";
import { MatrixError } from "../http-api";
import { sleep } from "../utils";
import { DEVICE_CODE_SCOPE, discoverAndValidateOIDCIssuerWellKnown } from "../oidc";
/**
  ...
  generateCode() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this.ourIntent === QrCodeMode.Reciprocate && _this.client) {
        _this._code = yield _this.channel.generateCode(_this.ourIntent, _this.client.getHomeserverUrl());
      ...
      if (_this2.didScanCode) {
        ...
        if (_this2.isNewDevice) {
          ...
          if ((_oidcClientConfig = oidcClientConfig) !== null && _oidcClientConfig !== void 0 && _oidcClientConfig.metadata.grant_types_supported.includes(DEVICE_CODE_SCOPE)) {
            var _this2$client$getHome, _this2$client;
            yield _this2.send({
              type: PayloadType.Protocols,
              protocols: ["device_authorization_grant"],
              homeserver: (_this2$client$getHome = (_this2$client = _this2.client) === null || _this2$client === void 0 ? void 0 : _this2$client.getHomeserverUrl()) !== null && _this2$client$getHome !== void 0 ? _this2$client$getHome : ""
            });
          } else {
            yield _this2.send({
