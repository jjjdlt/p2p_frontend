...
import { ClientRendezvousFailureReason, MSC4108FailureReason, MSC4108Payload, RendezvousFailureListener } from "..";
...
export declare class MSC4108SecureChannel {
    ...
    generateCode(mode: QrCodeMode.Reciprocate, homeserverBaseUrl: string): Promise<Uint8Array>;
    /**
