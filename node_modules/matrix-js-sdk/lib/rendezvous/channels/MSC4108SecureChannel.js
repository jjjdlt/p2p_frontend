...
export class MSC4108SecureChannel {
  ...
  generateCode(mode, homeserverBaseUrl) {
    var _this = this;
    return _asyncToGenerator(function* () {
      ...
      return new QrCodeData(_this.secureChannel.public_key(), url, mode === QrCodeMode.Reciprocate ? homeserverBaseUrl : undefined).to_bytes();
    })();
  }
