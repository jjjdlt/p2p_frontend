...
import { deepCopy, defer, noUnsafeEventProps, promiseMapSeries, unsafeProp } from "./utils";
import { Filter } from "./filter";
import { EventTimeline } from "./models/event-timeline";
import { logger } from "./logger";
import { ClientEvent, PendingEventOrdering } from "./client";
...
export class SyncApi {
  ...
  sync() {
    ...
    return _asyncToGenerator(function* () {
      ...
      (_global$window = global.window) === null || _global$window === void 0 || (_global$window$addEve = _global$window.addEventListener) === null || _global$window$addEve === void 0 || _global$window$addEve.call(_global$window, "online", _this5.onOnline, false);
