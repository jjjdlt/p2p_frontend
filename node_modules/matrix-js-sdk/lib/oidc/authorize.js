...
import { validateIdToken, validateStoredUserState, validateBearerTokenResponse } from "./validate";
...
var generateCodeChallenge = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (codeVerifier) {
    ...
    var utf8 = new TextEncoder().encode(codeVerifier);
    var digest = yield subtleCrypto.digest("SHA-256", utf8);
