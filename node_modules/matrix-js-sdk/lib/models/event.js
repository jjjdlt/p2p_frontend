...
import { EVENT_VISIBILITY_CHANGE_TYPE, EventType, RelationType, ToDeviceMessageId, UNSIGNED_THREAD_ID_FIELD, UNSIGNED_MEMBERSHIP_FIELD } from "../@types/event";
import { deepSortedObjectEntries, internaliseString } from "../utils";
import { THREAD_RELATION_TYPE, ThreadEvent } from "./thread";
...
export class MatrixEvent extends TypedEventEmitter {
  ...
  setClearDataForDecryptionFailure(reason) {
    ...
    this.encryptedDisabledForUnverifiedDevices = reason === "DecryptionError: ".concat(WITHHELD_MESSAGES["m.unverified"]);
    this.invalidateExtensibleEvent();
  }
