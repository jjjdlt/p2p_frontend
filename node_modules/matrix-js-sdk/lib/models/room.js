...
import { EventType, RoomCreateTypeField, RoomType, UNSTABLE_ELEMENT_FUNCTIONAL_USERS, EVENT_VISIBILITY_CHANGE_TYPE, RelationType, UNSIGNED_THREAD_ID_FIELD } from "../@types/event";
import { PendingEventOrdering, RoomVersionStability } from "../client";
import { Filter } from "../filter";
import { RoomStateEvent } from "./room-state";
import { BeaconEvent } from "./beacon";
import { Thread, ThreadEvent, FILTER_RELATED_BY_REL_TYPES, THREAD_RELATION_TYPE, FILTER_RELATED_BY_SENDERS, ThreadFilterType } from "./thread";
...
export class Room extends ReadReceipt {
  ...
  constructor(roomId, client, myUserId) {
    ...
    _defineProperty(this, "relations", new RelationsContainer(this.client, this));
    /**
  ...
  getRecommendedVersion() {
    var _this5 = this;
    return _asyncToGenerator(function* () {
      var capabilities = yield _this5.client.getCapabilities();
      ...
      if (result.urgent && result.needsUpgrade) {
        ...
        var caps = yield _this5.client.getCapabilities(true);
  ...
  addLiveEvents(events, addLiveEventOptions) {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (var i = 0; i < _this17.timelineSets.length; i++) {
        var liveTimeline = _this17.timelineSets[i].getLiveTimeline();
