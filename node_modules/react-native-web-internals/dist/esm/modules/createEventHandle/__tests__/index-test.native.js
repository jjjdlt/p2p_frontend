...
describe("create-event-handle", function() {
  ...
  beforeEach(function() {
    ...
    }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click"), output = ReactDOMServer.renderToString(/* @__PURE__ */ _jsx(Component, {}));
    ...
    test("event dispatched on target", function() {
      ...
      }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click");
      act(function() {
      ...
      }, listener = jest.fn(), listenerCapture = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
      });
      act(function() {
        root.render(/* @__PURE__ */ _jsx(Component, {}));
      ...
      }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click");
      act(function() {
        root.render(/* @__PURE__ */ _jsx(Component, {}));
      });
      ...
      }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addMagicEventListener = createEventHandle("magic-event");
      act(function() {
        root.render(/* @__PURE__ */ _jsx(Component, {}));
      }), act(function() {
      ...
      }, log = [], targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
      ...
      }, log = [], targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = createEventHandle("click"), addClickAltListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
