...
describe("use-event", function() {
  ...
  beforeEach(function() {
    ...
    test("event dispatched on target", function() {
      ...
      }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef();
      ...
      }, listener = jest.fn(), listenerCapture = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef();
      (0, import_test_utils.act)(function() {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
      });
      ...
      }, listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef();
      (0, import_test_utils.act)(function() {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
      });
      ...
      var Component = function(param) {
        var target2 = param.target, addClickListener = (0, import__.default)("click");
        return React.useEffect(function() {
      ...
      var Component = function(param) {
        var onClick = param.onClick, addClickListener = (0, import__.default)("click");
        return React.useEffect(function() {
          addClickListener(targetRef.current, onClick);
        }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ref: targetRef
        });
      }, listener = jest.fn(), listenerAlt = jest.fn(), targetRef = /* @__PURE__ */ React.createRef();
      (0, import_test_utils.act)(function() {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
          onClick: listener
        }));
      ...
      var Component = function(param) {
        var off = param.off, addClickListener = (0, import__.default)("click");
        return React.useEffect(function() {
      ...
      }, log = [], targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), listener = jest.fn(function(e) {
        log.push([
          "bubble",
          e.currentTarget.id
        ]);
      ...
      }, log = [], targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), listener = jest.fn(function(e) {
        log.push([
          "bubble",
          "target"
        ]);
