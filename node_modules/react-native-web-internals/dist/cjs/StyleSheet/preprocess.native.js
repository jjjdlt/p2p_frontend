...
var import_normalizeColor = __toESM(require("./compiler/normalizeColor")), import_normalizeValueWithProperty = __toESM(require("./compiler/normalizeValueWithProperty")), emptyObject = {}, defaultOffset = {
  ...
  var shadowColor = style.shadowColor, shadowOffset = style.shadowOffset, shadowOpacity = style.shadowOpacity, shadowRadius = style.shadowRadius, _ref = shadowOffset || defaultOffset, height = _ref.height, width = _ref.width, offsetX = (0, import_normalizeValueWithProperty.default)(width), offsetY = (0, import_normalizeValueWithProperty.default)(height), blurRadius = (0, import_normalizeValueWithProperty.default)(shadowRadius || 0), color = (0, import_normalizeColor.default)(shadowColor || "black", shadowOpacity);
  if (color != null && offsetX != null && offsetY != null && blurRadius != null)
    return "".concat(offsetX, " ").concat(offsetY, " ").concat(blurRadius, " ").concat(color);
}, createTextShadowValue = function(style) {
  var textShadowColor = style.textShadowColor, textShadowOffset = style.textShadowOffset, textShadowRadius = style.textShadowRadius, _ref = textShadowOffset || defaultOffset, height = _ref.height, width = _ref.width, radius = textShadowRadius || 0, offsetX = (0, import_normalizeValueWithProperty.default)(width), offsetY = (0, import_normalizeValueWithProperty.default)(height), blurRadius = (0, import_normalizeValueWithProperty.default)(radius), color = (0, import_normalizeValueWithProperty.default)(textShadowColor, "textShadowColor");
