  ...
  describe("atomic", function() {
    ...
    test("converts style to inline styles", function() {
      ...
      [
        ...
        test('ignores "left" properties for '.concat(dir), function() {
          var initial = {
        ...
        }), test('ignores "right" properties for '.concat(dir), function() {
          var initial = {
          ...
          expect((0, import_compiler.inline)(initial, isRTL)).toEqual(initial);
        }), test('ignores "left" values for '.concat(dir), function() {
          var initial = {
            clear: "left",
            float: "left",
            textAlign: "left",
          ...
          expect((0, import_compiler.inline)(initial, isRTL)).toEqual(initial);
        }), test('ignores "right" values for '.concat(dir), function() {
          var initial = {
            clear: "right",
            float: "right",
            textAlign: "right",
          ...
          expect((0, import_compiler.inline)(initial, isRTL)).toEqual(initial);
        }), test('converts "start" properties for '.concat(dir), function() {
          var initial = {
        ...
        }), test('converts "end" properties for '.concat(dir), function() {
          var initial = {
            borderEndColor: "red",
          ...
          expect((0, import_compiler.inline)(initial, isRTL)).toEqual(isRTL ? expectedRTL : expectedLTR);
        }), test('converts "start" values for '.concat(dir), function() {
          var initial = {
            clear: "start",
            float: "start",
            textAlign: "start",
          ...
          expect((0, import_compiler.inline)(initial, isRTL)).toEqual(isRTL ? expectedRTL : expectedLTR);
        }), test('converts "end" values for '.concat(dir), function() {
          var initial = {
            clear: "end",
            float: "end",
            textAlign: "end",
