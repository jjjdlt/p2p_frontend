...
function normalizeValueWithProperty(value, property) {
  ...
  return (property == null || !import_unitlessNumbers.unitlessNumbers[property]) && typeof value == "number" ? returnValue = "".concat(value, "px") : property != null && colorProps[property] && (returnValue = (0, import_normalizeColor.default)(value)), returnValue;
}
