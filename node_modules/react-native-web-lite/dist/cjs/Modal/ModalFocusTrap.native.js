...
var React = __toESM(require("react")), import_react_native_web_internals = require("react-native-web-internals"), import_createElement = __toESM(require("../createElement/index")), import_View = __toESM(require("../View"));
    ...
    if (import_react_native_web_internals.canUseDOM) {
      var trapFocus = function() {
        if (!(trapElementRef.current == null || focusRef.current.trapFocusInProgress || !active)) {
          try {
            if (focusRef.current.trapFocusInProgress = !0, _instanceof(document.activeElement, Node) && !trapElementRef.current.contains(document.activeElement)) {
