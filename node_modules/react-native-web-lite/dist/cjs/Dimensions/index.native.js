  ...
  return _create_class(Dimensions2, null, [
    {
      ...
      value: function(dimension) {
        return shouldInit && (shouldInit = !1, update()), (0, import_react_native_web_internals.invariant)(dimensions[dimension], "No dimension set for key ".concat(dimension)), dimensions[dimension];
      }
    },
    {
      key: "set",
