  ...
  return _create_class(AppRegistry2, null, [
    ...
    },
    {
      ...
      value: function(config) {
        config.forEach(function(param) {
          var appKey = param.appKey, component = param.component, run = param.run;
    ...
    },
    {
      ...
      value: function(appKey, appParameters) {
        ...
        if (isDevelopment) {
          var params = _object_spread({}, appParameters);
          params.rootTag = "#".concat(params.rootTag.id), console.log('Running application "'.concat(appKey, `" with appParams:
`), params, `
Development-level warnings: `.concat(isDevelopment ? "ON" : "OFF", ".") + `
Performance optimizations: `.concat(isDevelopment ? "OFF" : "ON", "."));
        }
        return (0, import_react_native_web_internals.invariant)(runnables[appKey] && runnables[appKey].run, 'Application "'.concat(appKey, '" has not been registered. ') + "This is either due to an import error during initialization or failure to call AppRegistry.registerComponent."), runnables[appKey].run(appParameters);
      }
    },
    {
