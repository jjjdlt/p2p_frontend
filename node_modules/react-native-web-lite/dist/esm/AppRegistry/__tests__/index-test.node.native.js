...
describe("AppRegistry", function() {
  describe("getApplication", function() {
    test("does not throw when missing appParameters", function() {
      ...
      var _AppRegistry_getApplication = AppRegistry.getApplication("App", {}), element = _AppRegistry_getApplication.element, getStyleElement = _AppRegistry_getApplication.getStyleElement, styleElement = ReactDOMServer.renderToStaticMarkup(getStyleElement());
      ...
      var getStyleElement = AppRegistry.getApplication("App", {}).getStyleElement, styleElement = getStyleElement({
        nonce
      });
      ...
      var getApplicationStyles = function(appName) {
        var getStyleElement = AppRegistry.getApplication(appName, {}).getStyleElement;
