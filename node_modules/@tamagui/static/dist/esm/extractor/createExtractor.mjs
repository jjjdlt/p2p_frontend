...
`, JSON.stringify(styles, null, 2), `
 classNames:`, JSON.stringify(classNames, null, 2), `
  rulesToInsert:`, out.rulesToInsert.flatMap(styleObject => styleObject[StyleObjectRules]).join(`
`)].join(" ")), definition.properties = definition.properties.map(prop => {
        ...
        }), out.rulesToInsert) for (const styleObject of out.rulesToInsert) onStyleRule?.(styleObject[StyleObjectIdentifier], styleObject[StyleObjectRules]);
