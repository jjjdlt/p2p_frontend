...
function createEvaluator(param) {
  var props = param.props, staticNamespace = param.staticNamespace, sourcePath = param.sourcePath, traversePath = param.traversePath, shouldPrintDebug = param.shouldPrintDebug, evalFn = function(n) {
    ...
    var evalContext = import_node_vm.default.createContext(staticNamespace), codeWithTypescriptAnnotations = "(".concat((0, import_generator.default)(n).code, ")"), code = import_esbuild.default.transformSync(codeWithTypescriptAnnotations, {
      loader: "tsx"
    }).code.replace(/;\n$/, "");
