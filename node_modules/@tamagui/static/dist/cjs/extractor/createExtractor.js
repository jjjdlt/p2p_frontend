...
`,
 ...
 classNames:`,
            ...
            `
  rulesToInsert:`,
            out.rulesToInsert.flatMap((styleObject) => styleObject[import_web.StyleObjectRules]).join(`
`)
          ].join(" ")
